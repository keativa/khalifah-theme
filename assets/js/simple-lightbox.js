...
var current, size;  
 $('.block-image a.each').click(function(e) {  

   
    e.preventDefault();								// prevent default click event
    var image_href = $(this).attr("href"); 			// grab href from clicked element    
    var slideNum = $('.block-image a.each').index(this);	    // determine the index of clicked trigger
...
// create HTML markup for lightbox window
      ...
      $('.block-image').find('a.each').each(function() {
