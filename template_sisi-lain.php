    ...
    <div class='wrap'>
      <div class='grid-3-1'>
        <div class='each'>
          ...
          <h1 class="head wow fadeInDown"><i class="icon-portfolio"></i> Sisi Lain</h1>
          <?php
          //$k_posts_beritahome = $data['k_posts_beritahome'];
          $my_query = null;
          $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
          //$my_query = new WP_Query(array('posts_per_page' => $k_posts_beritahome));
          $my_query = new WP_Query(array('category_name' => 'sisi-lain', 'paged' => $paged, 'posts_per_page' => 10));
