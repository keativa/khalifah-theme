  ...
  <div class='wrap-grid gal-home gal-home2'>
    <div class='wrap'>
      <div class="grid-4">
        <div class="summary">
          <h1 class="wow fadeInDown head" style="border-bottom: none;"><i class="icon-photo"></i> Galeri</h1>
        </div>
      </div>

      <div class='grid-4 mylightbox'>
      ...
      <a href="<?php bloginfo('url'); ?>/galeri">Lihat Semua Galeri <i class="icon-rarr"></i></a>
