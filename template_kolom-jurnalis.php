    ...
    <div class='wrap'>
      <div class='grid-3-1'>
        <div class='each'>
          ...
          <h1 class="head wow fadeInDown"><i class="icon-portfolio"></i> Kolom Jurnalis</h1>
          <?php
          $my_query = null;
          $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
          $my_query = new WP_Query(array('category_name' => 'kolom-jurnalis', 'paged' => $paged, 'posts_per_page' => 10));
